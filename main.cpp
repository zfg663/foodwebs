...
//	FILES
	...
	ofstream webData("stab_data.txt");				// behavior of food web
	// data is saved as:
	...
	ofstream sFile("species_param.txt");			// Species parameters
	ofstream pFile("producer_param.txt");			// Producer parameters
	// data is saved as:
